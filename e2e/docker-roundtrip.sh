...
case "$PRESET" in
  minimal)
    ...
    ;;
  amd64-full)
    plugins="docker-cli,docker-buildx,aws-cli,aws-sam-cli,github-cli,claude-code,copilot-cli,proto,mise,uv,bun,node,deno,dart,flutter,zig,rust,go,lazygit,starship,nerd-fonts,google-chrome,terraform,opentofu,kubectl,helm,shellcheck,shfmt,just,cocoon"
  ...
  arm64-full)
    ...
    plugins="docker-cli,docker-buildx,aws-cli,aws-sam-cli,github-cli,claude-code,copilot-cli,proto,mise,uv,bun,node,deno,dart,rust,go,nerd-fonts,terraform,opentofu,kubectl,helm,shellcheck,shfmt,just,cocoon"
    pins="aws-cli=2.34.48,aws-sam-cli=1.160.1,bun=1.3.3,cocoon=0.7.4,copilot-cli=1.0.47,dart=3.12.0,deno=2.7.14,docker-buildx=0.24.0,go=1.23.4,helm=3.16.0,just=1.51.0,kubectl=1.31.0,mise=2025.12.0,nerd-fonts=3.4.0,node=24.15.0,opentofu=1.9.0,proto=0.46.1,shellcheck=0.10.0,shfmt=3.10.0,terraform=1.10.5,uv=0.5.7"
