...
// would silently fall through aptMirrorOriginHosts to the Debian branch and
// break apt-mirror rewriting for any new Ubuntu-based image — a textbook
// case of the lockstep-desync hazard called out in .claude/rules/testing.md.
