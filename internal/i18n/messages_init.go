...
var messagesEN_init = map[string]string{
	...
	"init_desc_image_version_static":    "Type a tag, or press Tab to cycle through curated suggestions (e.g. 1.26.3-bookworm). Any well-formed tag the upstream registry publishes is accepted; allowed characters: letters, digits, dot, underscore, hyphen.",
...
var messagesJA_init = map[string]string{
	...
	"init_desc_image_version_static":    "タグを入力するか、Tab キーで推奨候補を循環できます (例: 1.26.3-bookworm)。上流レジストリが公開している正しい形式のタグなら自由に入力可。許可文字: 英数字、ドット、アンダースコア、ハイフン。",
