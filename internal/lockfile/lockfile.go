...
// than line-mutated like cocoon.toml.
package lockfile
...
const (
	...
	// root alongside cocoon.toml when [lockfile].name is unset. It aliases
...
// detect a lock that no longer matches cocoon.toml (a plugin added/removed
